...
// Name : David Khowanto, Louis, Abdurrahman Habibie, Elizabeth Kahny Dhea P.
// File Name : main.c
// Dependency : schedulemanual.h, assignasisten.h, load.h, save.h
//
// 
/* Description:
main program
...
3. Abdurrahman Habibie - 13217059 : completing the creation of program, test and debugging
									at the same time make the most of menu_utama and scan_jadwal
4. Elizabeth K. Dhea  P.- 13217068 : create the program and the main( ) 
*/
//***********************************************************//
