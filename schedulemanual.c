...
-ASUMSI UNTUK KELUAR MODE (INPUT Q/q) harus input pada kode_praktikum
-untuk validasi input asisten, hari, minggu, dan ruang dilakukan berulang hingga benar
 serta validasi beberapa syarat yang diberikan dari soal akan mengulang input dari awal
